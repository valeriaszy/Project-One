    ...
    .done(function (response) {
      ...
      for (var i = 0; i < 3; i++) {
        if (results[i].images.length > 0) {
          ...
          output += '<div style="display: inline-block; margin:5px"draggable="true"ondragstart="drag(event)"><img id="img" src="' + imgPath + '"><br><p style="color: blue">' + results[i].title + '</p><br></div>';
        }
      }
      output += '</div>';
